...
class Produit:
    ...
    def addProd(self, nom, description, prix, quantité, id_catégorie, tl):
        # requete
        req = f"""insert into {self.tableProd} (nom, description, prix, quantité, id_catégorie) \
            values \
            ("{nom}", "{description}", {prix}, "{quantité}", "{id_catégorie}");"""
    ...
    def updateProdStock(self, actualName, newStock, tl):
        ...
        # appliquer l'ajout de maniere permanente
        self.bd.commit()
        messagebox.showinfo("Info", message=f"La quantité du produit: {actualName} a été modifié.")
    ...
    # méthode pour récuperer les quantité de produits (pour mon graph)
    ...
    # méthode pour récupérer mes data (id, nom, descr, prix, quantité, catégorie)
    def displayDATA(self):
        # requete
        req = f"""select produits.id, produits.nom, description, prix, quantité, categories.nom \
            from {self.tableProd} inner join categories on produits.id_catégorie = categories.id;"""
